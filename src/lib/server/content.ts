...
export const SHARE_SNIPPETS: Array<ShareSnippet> = [
    ...
    },
    {
        ...
        date: "2025-03-12",
        isFeatured: false,
        comment: "Awesome that the developers at Microsoft, who own many in-house tools and languages, chose to use Go (a language from Google) for the new compiler.",
    },
    {
        ...
        date: "2025-03-7",
        isFeatured: false,
        comment: "Fantastic interview! I wish there was more long-form content from the upper ranks of software engineers.",
    },
    {
